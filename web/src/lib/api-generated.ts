...
export interface components {
    schemas: {
        ...
        AgentConfig: {
            ...
            /**
             * @description HMAC tool execution receipt configuration.
             * @default {
             *       "enabled": false,
             ...
             *     }
             */
            tool_receipts: components["schemas"]["ToolReceiptsConfig"];
        };
        ...
        ChannelsConfig: {
            ...
            /** @description WeChat personal iLink Bot channel configuration (QR code login). */
            wechat?: components["schemas"]["WeChatConfig"] | null;
        ...
        Config: {
            ...
            /**
             * @description Escalation routing configuration (`[escalation]`).
             * @default {
             *       "alert_channels": []
             *     }
             */
             ...
             *       "db_path": "/home/liteye/.zeroclaw/knowledge.db",
             *       "enabled": false,
             *       "max_nodes": 100000,
             ...
             *       "enabled": false,
             *       "max_plugins": 50,
             *       "plugins_dir": "/home/liteye/.zeroclaw/plugins",
             *       "security": {
             ...
             *       "jira_base_url": null,
             *       "report_output_dir": "/home/liteye/.zeroclaw/project-reports",
             ...
             *         "state_file": "/home/liteye/.zeroclaw/estop-state.json"
             *       },
             *       "nevis": {
             *         "client_id": "",
             *         "client_secret": null,
             ...
             *       "playbooks_dir": "/home/liteye/.zeroclaw/playbooks",
             *       "report_output_dir": "/home/liteye/.zeroclaw/security-reports",
             ...
             *       "workspaces_dir": "/home/liteye/.zeroclaw/workspaces"
             *     }
             */
        ...
        DiscordConfig: {
            ...
            /**
             * @description Channel-ID blocklist. Messages from these channels (or threads
            ...
            bot_token: string;
            /**
             * @description Channel-ID allowlist. When non-empty, only messages from these
            ...
            /**
             * @description Channels (or thread parents) listed here never require an
             *     @-mention, regardless of the global `mention_only` setting.
             *     Wins over `mention_required_channels` when both list the same ID.
             * @default []
             */
            mention_free_channels: string[];
            /**
             * @description When true, messages in a thread where the bot is a member are
             ...
             * @default true
             */
            mention_free_in_threads: boolean;
            /**
            ...
            /**
             * @description Channels (or thread parents) listed here always require an
             *     @-mention, even when the global `mention_only` is false.
             * @default []
             */
            mention_required_channels: string[];
            /**
             * Format: uint64
        ...
        /**
         * @description Escalation routing configuration (`[escalation]` section).
         *
        ...
        EscalationConfig: {
            /**
             * @description Channel names to alert on high/critical escalations (default: empty).
             *
        ...
        EstopConfig: {
             ...
             * @default /home/liteye/.zeroclaw/estop-state.json
             */
            state_file: string;
        };
        EvalConfig: {
        ...
        KnowledgeConfig: {
             ...
             * @default /home/liteye/.zeroclaw/knowledge.db
             */
            db_path: string;
            /**
        ...
        ModelProviderConfig: {
            ...
            /**
             * @description Arbitrary key/value pairs forwarded verbatim as `chat_template_kwargs`
            ...
            name?: string | null;
            /**
             * @description Override the provider's default for native tool calling.
            ...
            /**
             * Format: uint32
             * @description Override the Ollama `num_ctx` (context window, in tokens) sent on
            ...
            /**
             * Format: int32
             * @description Override the Ollama `num_predict` (max output tokens) sent on every
            ...
            /**
             * Format: double
             * @description Force every Ollama `/api/chat` request to use this temperature,
             ...
             */
            ollama_temperature_override?: number | null;
            /**
             * @description Per-provider input/output token pricing (USD per 1M tokens). When set,
            ...
            temperature?: number | null;
            /**
             * @description Enable or disable chain-of-thought thinking for models that support it
        ...
        NextcloudTalkConfig: {
            ...
            /**
             * Format: uint64
             * @description Minimum interval in milliseconds between consecutive OCS edit calls per
            ...
            proxy_url: string | null;
            /**
             * @description Controls whether and how streaming draft updates are delivered.
             *
        ...
        PatchResponse: {
            ...
            saved: boolean;
            /**
             * @description Non-fatal validation warnings against the post-save config state.
        ...
        PluginsConfig: {
             ...
             * @default /home/liteye/.zeroclaw/plugins
             */
            plugins_dir: string;
            /**
        ...
        ProjectIntelConfig: {
             ...
             * @default /home/liteye/.zeroclaw/project-reports
             */
        ...
        /**
         * PropResponse
         * @description Response for a non-secret GET / PUT / DELETE.
         */
        PropResponse: {
            path: string;
            value: unknown;
            /**
             * @description Non-fatal validation warnings against the current config state.
        ...
        SecurityOpsConfig: {
             ...
             * @default /home/liteye/.zeroclaw/playbooks
             */
            playbooks_dir: string;
            /**
             * @description Directory for generated security reports.
             * @default /home/liteye/.zeroclaw/security-reports
             */
            report_output_dir: string;
            /**
        ...
        SlackConfig: {
            ...
            /**
             * @description When true (and `mention_only` is also true), messages inside a Slack
             ...
             * @default false
             */
            strict_mention_in_thread: boolean;
            /**
        ...
        /**
         * @description HMAC tool execution receipt configuration (`[agent.tool_receipts]`).
         *
        ...
        ToolReceiptsConfig: {
            /**
             * @description Generate HMAC receipts on every tool execution. Default: `false`.
            ...
            enabled: boolean;
            /**
             * @description Inject the receipt-echo instruction into the system prompt so the
            ...
            /**
             * @description Append a trailing `Tool receipts:` block to user-visible replies so
        ...
        /**
         * @description One non-fatal validation issue surfaced after a successful save.
         *
         ...
         */
        ValidationWarning: {
            /** @description Stable machine-readable identifier for the warning class. */
            code: string;
            /** @description Human-readable description suitable for direct display. */
            message: string;
            /**
             * @description Dotted property path the warning concerns
        ...
        /**
         * @description WeChat personal iLink Bot channel configuration.
         *
        ...
        WeChatConfig: {
            /**
             * @description Allowed WeChat user IDs (e.g. `"xxx@im.wechat"`).
            ...
            allowed_users: string[];
            /**
             * @description Override the iLink API base URL. Default: `https://ilinkai.weixin.qq.com`.
             * @default null
             */
            api_base_url: string | null;
            /**
             * @description Override the CDN base URL. Default: `https://novac2c.cdn.weixin.qq.com/c2c`.
             * @default null
             */
            ...
            enabled: boolean;
            /**
             * @description Directory to persist bot token and sync cursor.
        ...
        WebSearchConfig: {
            ...
            max_results: number;
            /**
             * @description Search provider: "duckduckgo" (free), "brave" (requires API key), "tavily" (requires API key), or "searxng" (self-hosted)
             * @default duckduckgo
             */
            provider: string;
            /**
            ...
            /**
             * @description Tavily Search API key (required if provider is "tavily")
             * @default null
             */
        ...
        WorkspaceConfig: {
             ...
             * @default /home/liteye/.zeroclaw/workspaces
             */
